...
<body style="width:100%"> 
		...
		<!--     SIDE AREA -->
		    ...
		    <div class="sideArea">
		        ...
		        <ul class="sideMenu">
		            ...
		            <li><a href="menu_list.php"><span class="fa fa-sitemap"></span>My Interests</a></li>
		            <li><a href="invoice_list.php"><span class="fa fa-money"></span>My Purchase</a></li>
		            <li><a href="user_list.php"><span class="fa fa-user-o"></span>My Info</a></li>
        ...
        <section id="skills" style="margin-top:50vh; margin-right:15vh">
           <div id="skills_wrapper" style="width:70%; height:600px; border-top:1px #E6ECF8 solid">
